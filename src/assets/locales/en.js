...
const messages = defineMessages({
  ...
  sign_in_sub_title: "Free and premium users sign-in",
  sign_out: "Sign out",
  sign_up: "Sign up",
  submit: "Submit",
  email: "Email",
  email_placeholder: "example@host.com",
  email_invalid: "Please type a valid email address",
  email_not_found: "Email address not found",
  username: "Username",
  // deepcode ignore NoHardcodedPasswords: intended
  password: "Password",
  password_incorrect: "Password is incorrect...",
  password_placeholder: "Type...",
  password_invalid_title: "Password is invalid",
  password_invalid_score: "Password is not strong enough",
  password_invalid_min_lower:
    "Password must contain at least {number} lower-case letters",
  password_invalid_min_upper:
    "Password must contain at least {number} upper-case letters",
  password_invalid_min_length: "Password must contain at least {number} characters",
  password_invalid_min_symbols: "Password must contain at least {number} special symbols",
  password_invalid_min_numbers: "Password must contain at least {number} numbers",
  about: "About",
  home: "Home",
